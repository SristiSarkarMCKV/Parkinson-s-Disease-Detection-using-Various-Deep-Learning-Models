...
# ---------------------------------------------------------
# Robust AI Model Engine (Forces dataset download and fresh model training on startup)
# ---------------------------------------------------------
def get_trained_model():
    ...
    with st.spinner("Downloading dataset archive from Google Drive..."):
    ...
    with st.spinner("Training model dynamically from dataset images (please wait)..."):
        model.fit(
            train_generator,
            epochs=10,
